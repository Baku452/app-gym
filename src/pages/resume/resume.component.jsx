          ...
          <div className="instructors">
            <div className="instructor">
              <div className="instructor__profile">
                <img
                  src={'../assets/images/instructor/instructor1.jpg'}
                  alt=""
                />
            ...
            <div className="instructor">
              <div className="instructor__profile">
                <img
                  src={'../assets/images/instructor/instructor2.jpg'}
                  alt=""
                />
                <div className="instructor__description">
            ...
            <div className="instructor">
              <div className="instructor__profile">
                <img
                  src={'../assets/images/instructor/instructor3.jpg'}
                  alt=""
                />
                <div className="instructor__description">
            ...
            <div className="instructor">
              <div className="instructor__profile">
                <img
                  src={'../assets/images/instructor/instructor4.jpg'}
                  alt=""
                />
                <div className="instructor__description">
                  <span>Pedro Gonzales</span>
            ...
            <div className="instructor">
              <div className="instructor__profile">
                <img
                  src={'../assets/images/instructor/instructor5.jpg'}
                  alt=""
                />
                <div className="instructor__description">
                  <span>Pedro Gonzales</span>
