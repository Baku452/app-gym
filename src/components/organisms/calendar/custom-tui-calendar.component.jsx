  ...
  (
      ...
      calendarInstRef.current = new TuiCalendar(tuiRef.current, {
        ...
        template: {
          ...
          monthGridHeaderExceed: function (hiddenSchedules) {
            return (
              '<span class="weekday-grid-more-schedules">+' + hiddenSchedules + '</span>'
            );
          },
          ...
          timegridCurrentTime: function (timezone) {
            ...
            if (timezone.dateDifference) {
              templates.push(
                '[' + timezone.dateDifferenceSign + timezone.dateDifference + ']<br>',
              );
            }
    ...
    function setRenderRangeText() {
      ...
      if (viewName === 'day') {
        ...
        html.push(' ~ ');
        html.push(
          moment(calendarInstRef.current.getDateRangeEnd().getTime()).format(' MM.DD'),
        );
      }
    ...
    function _getTimeTemplate(schedule, isAllDay) {
      ...
      if (!isAllDay) {
        html.push(
          '<strong>' + moment(schedule.start.toDate()).format('HH:mm') + '</strong> ',
        );
      }
